...
public class MovieService {
    ...
    public Movie save(Movie movie) {
        movie.setCategories(findCategories(movie.getCategories())); // Setando nas Categories
        movie.setStreamings(findStreamings(movie.getStreamings())); // Setando nos Streamings
    ...
    private List<Category> findCategories(List<Category> categories) {
        ...
        // Faz um forEach nos categories que mandamos, categoryService.findById faz uma pesquisa de cada Id e depois se ele existir adiciona dentro do categoriesFound!
